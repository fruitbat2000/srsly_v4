		...
		render: function() {
			var projects = this.props.data.map(function (project) {
				var projectSkills = project.skills.map(function (skill) {
					return (
						React.createElement("li", null, skill)
					)
				});
				return (
					React.createElement("li", null, 
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Skills = React.createClass({displayName: "Skills",
		...
		render: function() {
			return (
				React.createElement(SkillList, {data: this.state.data})
			);
		}
	});
			...
			var brands = this.props.data.map(function (brand) {
				return (
					React.createElement("li", null, 
						...
						React.createElement("label", {for: brand}, brand)
					)
				)
			});
			return (
		...
		render: function() {
			return (
				React.createElement("aside", {className: "filters"}, 
					React.createElement(FilterSkills, {data: this.state.data.skills}), 
					React.createElement(FilterBrands, {data: this.state.data.brands})
				)
			);
		}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var adler32 = __webpack_require__(104);
